...
declare interface IValidClientSchema extends Document {
    id: string;
    ipAddress: string;
    name: string;
    description: string;
...
export interface IValidClientModel extends Model<IValidClientSchema>{}

export class ValidClientSchema {
    private _model: Model<IValidClientSchema>
    ...
    constructor() {
        ...
        this._model = model<IValidClientSchema>('ValidClients', schema);
    }

    public get model(): Model<IValidClientSchema> {
        return this._model
    }
}